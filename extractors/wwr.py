# 이 파일 안에 extract_jobs function 만들기
# extract_jobs는 키워드를 받게 될 것이다.
# python,react,java..등등 검색을 원하는 키워드를 넘겨 줄 것이다.
...
def extract_wwr_jobs(keyword):
    ...
    #  웹사이트를 받아올 때 get 메서드를 사용! 
    # keyword를 통해 입력 값을 받을 것이므로 keyword로 바꿔 준다.
    ...
    # 이 python list를 만들었고, 즉 이제 for resulit in을 사용 가능 하다.
        ...
        # 나중에 파일을 넣을 수 있도록  result로 반환한다(단순히 print만을 할 것이기 아니기 때문이다)
        return results
